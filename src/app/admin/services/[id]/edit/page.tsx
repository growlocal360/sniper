  ...
  return (
    <div>
      ...
      <div className="mb-8">
        ...
        <h1 className="text-3xl font-bold text-tactical-100">Edit Service</h1>
        <p className="text-tactical-400 mt-1">Update service details</p>
      </div>
      ...
      >
        ...
        <div>
          <label className="block text-sm font-medium text-tactical-300 mb-2">
            Tagline <span className="text-crimson-400">*</span>
          </label>
          <input
            type="text"
            value={tagline}
        ...
        <div className="flex items-center space-x-4 pt-4 border-t border-tactical-700">
          ...
          >
            ...
            <span>{saving ? "Saving..." : "Update Service"}</span>
          </button>
          <Link
            href="/admin/services"
